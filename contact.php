...
<section class="contact">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>phone number</h3>
         <p style="font-size: medium;">013 486 8864</p>
      </div>

      <div class="box">
         <i class="fas fa-envelope"></i>
         <h3>email address</h3>
         <p style="font-size: medium;">projectXdev@gmail.com</p>
      ...
      <div class="box">
         ...
         <p style="font-size: medium;">North West University, Mmmabatho Unit 5</p>
      </div>
